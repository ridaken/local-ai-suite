...
ARTICLE_READ_WINDOW_CHARS = _bounded_int("ARTICLE_READ_WINDOW_CHARS", 4000, 500, 16000)
ARTICLE_DOWNLOAD_MAX_BYTES = _bounded_int(
    "ARTICLE_DOWNLOAD_MAX_BYTES", 32 * 1024 * 1024, 1024 * 1024, 64 * 1024 * 1024
)
ARTICLE_CACHE_MAX_BYTES = _bounded_int(
    "ARTICLE_CACHE_MAX_BYTES", 128 * 1024 * 1024, 1024 * 1024, 1024 * 1024 * 1024
)
ARTICLE_CACHE_MAX_ITEMS = _bounded_int("ARTICLE_CACHE_MAX_ITEMS", 16, 1, 256)
ARTICLE_CACHE_TTL_SECONDS = _bounded_int("ARTICLE_CACHE_TTL_SECONDS", 3600, 60, 86400)
...
ARTICLE_FIND_CONCURRENCY = _bounded_int("ARTICLE_FIND_CONCURRENCY", 2, 1, 16)
ARTICLE_READ_CONCURRENCY = _bounded_int("ARTICLE_READ_CONCURRENCY", 4, 1, 32)
